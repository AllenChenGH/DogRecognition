To run this part, you should download Stanford Dogs dataset by yourself, and make sure you put folders ‘Annotation’ and ‘Images’ into the correct path and install all of the python package we used.
